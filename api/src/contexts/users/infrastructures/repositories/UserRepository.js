...
var UserRepository = /** @class */ (function () {
    ...
    UserRepository.prototype.findBy = function (id) {
        throw new Error("Method not implemented.");
    };
    UserRepository.prototype.findByEmail = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.prisma.users.findUnique({ where: { email: email } })];
    ...
    UserRepository.prototype.create = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.prisma.users.create({ data: data })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
